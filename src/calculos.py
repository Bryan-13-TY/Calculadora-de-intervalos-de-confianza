...
def _calcular_grados_libertad_efectivos(
    ...
    :param varianza_muestral_1: Varianza muestral (𝑠₁²) de una primera muestra.
    :type varianza_muestral_1: float
    :param varianza_muestral_2: Varianza muestral (𝑠₂²) de una segunda muestra.
    ...
    :return: Grados de libertad efectivos (ν) redondeados a cuatro decimales.
    :rtype: float
    """
...
def _calcular_desviacion_estandar_combinada(
    ...
    :param tamano_muestra_2: Tamaño de una segunda muestra (n₂).
    :type tamano_muestra_2: int
    :return: Desviación estándar combinada (Sp) redondeada a cuatro decimales. 
    :rtype: float
    """
...
def _calcular_proporcion_muestral(numero_exitos: int, tamano_muestra: int) -> float:
    ...
    :param numero_exitos: Número de exitos (X) de una proporción problacional.
...
def _calcular_valor_critico_normal_estandar(porcentaje_confianza: int) -> float:
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
...
def _calcular_valor_critico_f(
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
    :type porcentaje_confianza: int
    :return: Valor crítico superior e inferior de la distribución redondeados a cuatro decimales.
...
def intervalo_caso_1(
    ...
    - Situación: Distribución normal, muestra grande y varianza conocida.
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
    :type porcentaje_confianza: int
    :param desv_estandar_poblacional: Desviación estándar poblacional (σ).
    :type desv_estandar_poblacional: float
    :return: Límite superior e inferior del intervalo y la media muestral (X̄).
...
def intervalo_caso_2(
    ...
    Calcula el intervalo de confianza para la siguiente situación:
    - Parámetro a estimar: Una media poblacional (μ).
    - Situación: Distribución normal, muestra grande y varianza desconocida.
    - Estimador puntual: Una media muestral (X̄).
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
    :type porcentaje_confianza: int
    :return: Límite superior e inferior del intervalo, media muestral (X̄) y la desviación estándar muestral (𝑠).
    :rtype: tuple[float, float, float, float]
    """
    # datos necesarios
    media_muestral = _calcular_media(muestra)
    valor_critico_t = _calcular_valor_critico_t_student(porcentaje_confianza, tamano_muestra, 2)
    desv_estandar_muestral = math.sqrt(_calcular_varianza_muestral(tamano_muestra, muestra, media_muestral))
...
def intervalo_caso_3(
    ...
    """
    Calcula el intervalo de confianza para la siguiente situación:
    - Parámetro a estimar: Diferencia de medias poblacionales (μ₁ - μ₂).
    - Situación: Para dos muestras independientes de poblaciones normales con varianzas conocidas.
    ...
    :param tamano_muestra_2: Tamaño de una segunda muestra (n₂).
    :type tamano_muestra_2: int
    :param desv_estandar_poblacional_1: Desviación estándar poblacional de una primera muestra (σ₁).
    :type desv_estandar_poblacional_1: float
    :param desv_estandar_poblacional_2: Desviación estándar poblacional de una segunda muestra (σ₂).
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
    :type porcentaje_confianza: int
    :return: Límite superior e inferior del intervalo y la diferencia de medias mustrales (X̄₁ - X̄₂).
    :rtype: tuple[float, float, float]
    """
    # datos necesarios
...
def intervalo_caso_4(
    ...
    Calcula el intervalo de confianza para la siguiente situación:
    - Parámetro a estimar: Diferencia de medias poblacionales (μ₁ - μ₂).
    - Situación: Para dos muestras grandes (n > 30) independientes de poblaciones normales con varianzas diferentes y desconocidas.
    - Estimador puntual: Diferencia de medias muestrales (X̄₁ - X̄₂).
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
    :type porcentaje_confianza: int
    :return: Límite superior e inferior del intervalo, media muestral de una primera muestra (X̄₁) y la media muestral de una segunda muestra (X̄₂).
    :rtype: tuple[float, float, float, float]
    """
    # datos necesarios
    media_muestral_1 = _calcular_media(muestra_1)
    media_muestral_2 = _calcular_media(muestra_2)
    valor_critico_Z = _calcular_valor_critico_normal_estandar(porcentaje_confianza)
    varianza_muestral_1 = _calcular_varianza_muestral(tamano_muestra_1, muestra_1, media_muestral_1)
    varianza_muestral_2 = _calcular_varianza_muestral(tamano_muestra_1, muestra_2, media_muestral_2)

    # intervalos
    raiz = math.sqrt((varianza_muestral_1 / tamano_muestra_1) + (varianza_muestral_2 / tamano_muestra_2))
    intervalo_l = (media_muestral_1 - media_muestral_2) - (valor_critico_Z * raiz)
    intervalo_u = (media_muestral_1 - media_muestral_2) + (valor_critico_Z * raiz)
    return (
        intervalo_l,
...
def intervalo_caso_5(
    ...
    Calcula el intervalo de confianza para la siguiente situación:
    - Parámetro a estimar: Diferencia de medias poblacionales (μ₁ - μ₂).
    - Situación: Para dos muestras chicas independientes de poblaciones normales con varianzas diferentes y desconocidas.
    - Estimador puntual: Diferencia de medias muestrales (X̄₁ - X̄₂).
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
    :type porcentaje_confianza: int
    :return: Límite superior e inferior del intervalo, diferencia de medias mustrales (X̄₁ - X̄₂), valor crítico de la distribución t y los grados de libertad efectivos (ν).
    ...
    media_muestral_2 = _calcular_media(muestra_2)
    varianza_muestral_1 = _calcular_varianza_muestral(tamano_muestra_1, muestra_1, media_muestral_1)
    varianza_muestral_2 = _calcular_varianza_muestral(tamano_muestra_2, muestra_2, media_muestral_2)
    grados_libertad_efectivos = _calcular_grados_libertad_efectivos(varianza_muestral_1,
                                                                    varianza_muestral_2,
                                                                    tamano_muestra_1,
                                                                    tamano_muestra_2)
    valor_critico_t = _calcular_valor_critico_t_student(porcentaje_confianza, grados_libertad_efectivos, 5)
    ...
    return intervalo_l, intervalo_u, media_muestral_1 - media_muestral_2, valor_critico_t, grados_libertad_efectivos
...
def intervalo_caso_6(
    ...
    Calcula el intervalo de confianza para la siguiente situación:
    - Parámetro a estimar: Diferencia de medias poblacionales (μ₁ - μ₂).
    - Situación: Para dos muestras independientes de poblaciones normales con varianzas iguales y desconocidas.
    - Estimador puntual: Diferencia de medias muestrales (X̄₁ - X̄₂).
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
    :type porcentaje_confianza: int
    :return: Límite superior e inferior del intervalo, diferencia de medias muestrales (X̄₁ - X̄₂), valor crítico de la distribución t y los grados de libertad para la distribución.
    :rtype: tuple[float, float, float, float, float]
    """
    # datos necesarios
    media_muestral_1 = _calcular_media(muestra_1)
    ...
    varianza_muestral_1 = _calcular_varianza_muestral(tamano_muestra_1, muestra_1, media_muestral_1)
    varianza_muestral_2 = _calcular_varianza_muestral(tamano_muestra_2, muestra_2, media_muestral_2)
    desv_estandar_combinada = _calcular_desviacion_estandar_combinada(varianza_muestral_1,
                                                                      varianza_muestral_2,
                                                                      tamano_muestra_1,
                                                                      tamano_muestra_2)
    valor_critico_t = _calcular_valor_critico_t_student(porcentaje_confianza, float(tamano_muestra_1 + tamano_muestra_2), 6)

    # intervalos
    raiz = math.sqrt((1 / tamano_muestra_1) + (1 / tamano_muestra_2))
    intervalo_l = (media_muestral_1 - media_muestral_2) - (valor_critico_t * desv_estandar_combinada * raiz)
    intervalo_u = (media_muestral_1 - media_muestral_2) + (valor_critico_t * desv_estandar_combinada * raiz)
    return (
        intervalo_l,
        intervalo_u,
...
def intervalo_caso_7(
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
    :type porcentaje_confianza: int
    :return: Límite superior e inferior del intervalo, proporción muestral (𝑝) y el valor crítico de la distribución normal estándar (Z).
    :rtype: tuple[float, float, float, float]
    """
    # datos necesarios
...
def intervalo_caso_8(
    ...
    """
    Calcula el intervalo de confianza para la siguiente situación:
    - Parámetro a estimar: Diferencia de proporciones poblacionales (𝑃₁ - 𝑃₂).
    - Situación: Para dos muestra grandes e independientes de una distribución normal.
    - Estimador puntual: Diferencia de proporciones muestrales (𝑝₁ - 𝑝₂).
    
    :param numero_exitos_1: Número de exitos de una primera muestra (X₁).
    :type numero_exitos_1: int
    :param numero_exitos_2: Númeor de exitos de uan segunda muestra (X₂).
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
    :type porcentaje_confianza: int
    :return: Límite superior e inferior del intervalo, diferencia de proporciones muestrales (𝑝₁ - 𝑝₂), y el valor crítico de la distribución normal estándar (Z).
    :rtype: tuple[float, float, float, float]
    """
    # datos necesarios
    ...
    return intervalo_l, intervalo_u, proporcion_muestral_1 - proporcion_muestral_2, valor_critico_Z
...
def intervalo_caso_9(
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
    :type porcentaje_confianza: int
    :return: Límite superior e inferior del intervalo, varianza muestral (𝑠²) y los grados de libertad para la distribución.
    :rtype: tuple[float, float, float, float]
    """
    # datos necesarios
    media_muestral = _calcular_media(muestra)
    varianza_muestral = _calcular_varianza_muestral(tamano_muestra, muestra, media_muestral)
    chi2_superior, chi2_inferior = _calcular_valor_critico_chi_cuadrada(porcentaje_confianza, tamano_muestra)
...
def intervalo_caso_10(
    ...
    """
    Calcula el intervalo de confianza para la siguiente situación:
    - Parámetro a estimar: Cociente de varianzas poblacionales (σ₁² / σ₂²).
    - Situación: Para dos muestras independientes de poblaciones normales.
    ...
    :param porcentaje_confianza: Porcentaje de confianza para un intervalo de confianza.
    :type porcentaje_confianza: int
    :return: Límite superior e inferior del intervalo, estatus de la varianza muestral, grados de libertad x3 para la distribución.
    ...
    varianza_muestral_1 = _calcular_varianza_muestral(tamano_muestra_1, muestra_1, media_muestral_1)
    varianza_muestral_2 = _calcular_varianza_muestral(tamano_muestra_2, muestra_2, media_muestral_2) 
    f_superior, f_inferior = _calcular_valor_critico_f(tamano_muestra_1, tamano_muestra_2, porcentaje_confianza)
